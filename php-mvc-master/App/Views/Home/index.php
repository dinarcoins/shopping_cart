                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                            <div class="navbar-nav">
                                <a class="nav-item nav-link" href="/public">Home</a>
                                <a class="nav-item nav-link" href="/public/collection">Collection</a>
                                <a class="nav-item nav-link" href="/public/shoes">Shoes</a>
                                <a class="nav-item nav-link" href="/public/racing-boots">Racing Boots</a>
                                <a class="nav-item nav-link" href="/public/contact">Contact</a>
                                <a class="nav-item nav-link last" href="#"><img src="public/images/search_icon.png"></a>
                                <a class="nav-item nav-link last" href="public/contact.html"><img src="public/images/shop_icon.png"></a>
                            </div>
                        </div>
                    </nav>
                </div>
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-5">
                                            <div class="shoes_img"><img src="public/images/running-shoes.png"></div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="about-img">
                            ...
                            <div class="shoes-img"><img src="public/images/shoes-img1.png"></div>
                            <p class="sport_text">Men Sports</p>
                            <div class="dolar_text">$<strong style="color: #f12a47;">90</strong> </div>
                            <div class="star_icon">
                                <ul>
                                    <li><a href="#"><img src="public/images/star-icon.png"></a></li>
                                    <li><a href="#"><img src="public/images/star-icon.png"></a></li>
                                    <li><a href="#"><img src="public/images/star-icon.png"></a></li>
                                    <li><a href="#"><img src="public/images/star-icon.png"></a></li>
                                    <li><a href="#"><img src="public/images/star-icon.png"></a></li>
                    ...
                    <div class="col-md-6">
                        <div class="about-img2">
                            <div class="shoes-img2"><img src="public/images/shoes-img2.png"></div>
                            <p class="sport_text">Men Sports</p>
                            <div class="dolar_text">$<strong style="color: #f12a47;">90</strong> </div>
                            <div class="star_icon">
                                <ul>
    ...
    <div class="collectipn_section_3 layuot_padding">
        <div class="container">
            <div class="racing_shoes">
                <div class="row">
                    <div class="col-md-8">
                        <div class="shoes-img3"><img src="public/images/shoes-img3.png"></div>
                    </div>
                    <div class="col-md-4">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="best_shoes">
                        ...
                        <div class="shoes_icon"><img src="public/images/shoes-img4.png"></div>
                        <div class="star_text">
                            <div class="left_part">
                                <ul>
                                    <li><a href="#"><img src="public/images/star-icon.png"></a></li>
                ...
                <div class="col-sm-4">
                    <div class="best_shoes">
                        <p class="best_text">Best Shoes </p>
                        <div class="shoes_icon"><img src="public/images/shoes-img5.png"></div>
                        <div class="star_text">
                            <div class="left_part">
                                <ul>
                                    <li><a href="#"><img src="public/images/star-icon.png"></a></li>
                ...
                <div class="col-sm-4">
                    <div class="best_shoes">
                        <p class="best_text">Best Shoes </p>
                        <div class="shoes_icon"><img src="public/images/shoes-img6.png"></div>
                        <div class="star_text">
                            <div class="left_part">
                                <ul>
                                    <li><a href="#"><img src="public/images/star-icon.png"></a></li>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="best_shoes">
                        ...
                        <div class="shoes_icon"><img src="public/images/shoes-img7.png"></div>
                        <div class="star_text">
                            <div class="left_part">
                                <ul>
                                    <li><a href="#"><img src="public/images/star-icon.png"></a></li>
                ...
                <div class="col-sm-4">
                    <div class="best_shoes">
                        <p class="best_text">Sports Shoes</p>
                        <div class="shoes_icon"><img src="public/images/shoes-img8.png"></div>
                        <div class="star_text">
                            <div class="left_part">
                                <ul>
                                    <li><a href="#"><img src="public/images/star-icon.png"></a></li>
                ...
                <div class="col-sm-4">
                    <div class="best_shoes">
                        <p class="best_text">Sports Shoes</p>
                        <div class="shoes_icon"><img src="public/images/shoes-img9.png"></div>
                        <div class="star_text">
                            <div class="left_part">
                                <ul>
                                    <li><a href="#"><img src="public/images/star-icon.png"></a></li>
            ...
            <div class="mail_section">
                <div class="row">
                    <div class="col-sm-6 col-lg-2">
                        <div><a href="#"><img src="public/images/footer-logo.png"></a></div>
                    </div>
                    <div class="col-sm-6 col-lg-2">
                        <div class="footer-logo"><img src="public/images/phone-icon.png"><span class="map_text">(71) 1234567890</span></div>
                    </div>
                    <div class="col-sm-6 col-lg-3">
                        <div class="footer-logo"><img src="public/images/email-icon.png"><span class="map_text">Demo@gmail.com</span></div>
                    </div>
                    <div class="col-sm-6 col-lg-3">
                        <div class="social_icon">
                            <ul>
                                ...
                                <li><a href="#"><img src="public/images/in-icon.png"></a></li>
                                <li><a href="#"><img src="public/images/google-icon.png"></a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="footer_section_2">
                <div class="row">
                    ...
                    <div class="col-sm-4 col-lg-2">
                        ...
                        <div class="image-icon"><img src="public/images/map-icon.png"><span class="pet_text">No 40 Baria Sreet 15/2 NewYork City, NY, United States.</span></div>
                    </div>
